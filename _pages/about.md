...
- **probabilistic programming** for managing uncertainty;
- **differentiable programming** for pattern recognition, amortized inference;
- **program synthesis** for knowledge representation and manipulation;
